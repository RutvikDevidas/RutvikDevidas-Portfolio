...
## SeedAllTables
You can execute the `SeedAllTables` Mutation using the `UseMutationResult` object returned by the following Mutation hook function (which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts)):
```javascript
useSeedAllTables(options?: useDataConnectMutationOptions<SeedAllTablesData, FirebaseError, void>): UseDataConnectMutationResult<SeedAllTablesData, undefined>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useSeedAllTables(dc: DataConnect, options?: useDataConnectMutationOptions<SeedAllTablesData, FirebaseError, void>): UseDataConnectMutationResult<SeedAllTablesData, undefined>;
```

### Variables
The `SeedAllTables` Mutation has no variables.
### Return Type
Recall that calling the `SeedAllTables` Mutation hook function returns a `UseMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `UseMutationResult.status` field. You can also check for pending / success / error status using the `UseMutationResult.isPending`, `UseMutationResult.isSuccess`, and `UseMutationResult.isError` fields.

To execute the Mutation, call `UseMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation.

To access the data returned by a Mutation, use the `UseMutationResult.data` field. The data for the `SeedAllTables` Mutation is of type `SeedAllTablesData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `SeedAllTables`'s Mutation hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig } from '@dataconnect/generated';
import { useSeedAllTables } from '@dataconnect/generated/react'

export default function SeedAllTablesComponent() {
  // Call the Mutation hook function to get a `UseMutationResult` object which holds the state of your Mutation.
  const mutation = useSeedAllTables();

  // You can also pass in a `DataConnect` instance to the Mutation hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const mutation = useSeedAllTables(dataConnect);

  // You can also pass in a `useDataConnectMutationOptions` object to the Mutation hook function.
  const options = {
    onSuccess: () => { console.log('Mutation succeeded!'); }
  };
  const mutation = useSeedAllTables(options);
  ...
  const mutation = useSeedAllTables(dataConnect, options);
  ...
  if (mutation.isSuccess) {
    ...
    console.log(mutation.data.experience_insert);
    console.log(mutation.data.contactMessage_insert);
  }
...
## UpdateMyBio
You can execute the `UpdateMyBio` Mutation using the `UseMutationResult` object returned by the following Mutation hook function (which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts)):
```javascript
useUpdateMyBio(options?: useDataConnectMutationOptions<UpdateMyBioData, FirebaseError, UpdateMyBioVariables>): UseDataConnectMutationResult<UpdateMyBioData, UpdateMyBioVariables>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useUpdateMyBio(dc: DataConnect, options?: useDataConnectMutationOptions<UpdateMyBioData, FirebaseError, UpdateMyBioVariables>): UseDataConnectMutationResult<UpdateMyBioData, UpdateMyBioVariables>;
```
...
```
### Return Type
Recall that calling the `UpdateMyBio` Mutation hook function returns a `UseMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `UseMutationResult.status` field. You can also check for pending / success / error status using the `UseMutationResult.isPending`, `UseMutationResult.isSuccess`, and `UseMutationResult.isError` fields.

To execute the Mutation, call `UseMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation.

To access the data returned by a Mutation, use the `UseMutationResult.data` field. The data for the `UpdateMyBio` Mutation is of type `UpdateMyBioData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `UpdateMyBio`'s Mutation hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, UpdateMyBioVariables } from '@dataconnect/generated';
import { useUpdateMyBio } from '@dataconnect/generated/react'

export default function UpdateMyBioComponent() {
  // Call the Mutation hook function to get a `UseMutationResult` object which holds the state of your Mutation.
  const mutation = useUpdateMyBio();

  // You can also pass in a `DataConnect` instance to the Mutation hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const mutation = useUpdateMyBio(dataConnect);

  // You can also pass in a `useDataConnectMutationOptions` object to the Mutation hook function.
  const options = {
    onSuccess: () => { console.log('Mutation succeeded!'); }
  };
  const mutation = useUpdateMyBio(options);
  ...
  const mutation = useUpdateMyBio(dataConnect, options);

  // After calling the Mutation hook function, you must call `UseMutationResult.mutate()` to execute the Mutation.
  // The `useUpdateMyBio` Mutation requires an argument of type `UpdateMyBioVariables`:
  const updateMyBioVars: UpdateMyBioVariables = {
    bio: ..., 
  };
  mutation.mutate(updateMyBioVars);
  ...
  mutation.mutate(updateMyBioVars, options);
